...
export function makeActionCreator<T extends string>       (type: T): EmptyActionCreator<T> & EmptyAction<T>
export function makeActionCreator<T extends string, P>    (type: T): ActionPayloadCreator<T, P> & EmptyAction<T>
export function makeActionCreator<T extends string, P, M> (type: T): ActionMetaCreator<T, P, M> & EmptyAction<T>
export function makeActionCreator<T extends string, P, M> (type: T): EmptyActionCreator<T> & ActionPayloadCreator<T, P> & ActionMetaCreator<T, P, M> & EmptyAction<T> {
